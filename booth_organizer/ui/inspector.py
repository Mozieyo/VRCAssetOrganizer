...
from booth_organizer.tag_data import TOP_AVATARS, GENRE_NAMES
from booth_organizer.ui.chip_button import ChipToggleButton
from booth_organizer.ui.flow_layout import FlowLayout
...
class InspectorPanel(QWidget):
    ...
    def _refresh_tools(self):
        ...
        if self._tool_registry:
            ...
            from booth_organizer.tools.registry import DEFAULT_TOOL_MAP
